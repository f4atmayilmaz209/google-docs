export const templates = [
    ...
    { id: "software-proposal", label: "Software development proposal", imageUrl: "/software-proposal.svg",initialContent:
        `
            <h1>Software Development</h1>
            <h2>Project Overview</h2>
            <p>Drief desription of the proposed software development project.</p>
            <h2>Scope of Work</h2>
    ...
    { id: "project-proposal", label: "Project proposal", imageUrl:"/project-proposal.svg",
        ...
        <p>Brief oberview of the project proposal.</p>
        <h2>Project Goals</h2>
    ...
    { id: "resume", label: "Resume", imageUrl:"/resume.svg",
        ...
        <p>Strategy and methodology for project execution.</p>
        <h2>Education</h2>
        <p>[Degree] - [Institution]<br>[Graduation]</p>
        h2>Skills</h2>
    ...
    { id: "letter", label: "Letter", imageUrl:"letter.svg",
        ...
        `
            ...
            <p>Dear [Recipient],</p>
            <p>I hope this email finds you email.</p>
            <p>[Email Body]<br>
                [Your Name]
