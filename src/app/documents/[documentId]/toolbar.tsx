...
const LinkButton=()=>{
    ...
    return(
        <DropdownMenu onOpenChange={(open)=>{         
            ...
            <DropdownMenuTrigger  asChild>
                <button className="h-7 min-w-7 shrink-0 flex justify-center  flex-col items-center rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm"> 
...
const HighlightColorButton=()=>{
    ...
    return(
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <button className="h-7 min-w-7 justify-center shrink-0 flex flex-col items-center rounded-sm hover:bg-neutral-200/80 px-1.5 overflow-hidden text-sm"> 
...
const ToolbarButton=({onClick,isActive,icon:Icon}:ToolbarButtonProps)=>{
    return(
        <button onClick={onClick} className={cn("text-sm min-w-7 flex items-center justify-center rounded-dm hover:bg-neutral-200/80",
            isActive && "bg-neutral-200/80"
